...
class Hackernxt extends StatefulWidget {
  ...
  @override
  State<Hackernxt> createState() => _HackernxtState();
}

class _HackernxtState extends State<Hackernxt> {

  Future<void>hackernxt() async{
    String formattedDate = DateFormat('yyyy-MM-dd').format(DateTime.now());
    String url = 'https://clist.by/api/v4/contest/?limit=15&host=hackerearth.com&start__gt=$formattedDate&order_by=start';
    try {
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              SizedBox(width: 30),
              Image.asset(
                'assets/CodingPlatformsIcons/img_3.png',
                height: 30,
                width: 30,
              ),
              SizedBox(width: 10),
            ...
            child: GNav(
              ...
              tabs: [
                GButton(
                  ...
                  text: 'Past Contest',
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Hackerearth()));
                  },
                ),
                GButton(
